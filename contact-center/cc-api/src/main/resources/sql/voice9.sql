...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_CRON_TRIGGERS` (`SCHED_NAME`, `TRIGGER_NAME`, `TRIGGER_GROUP`, `CRON_EXPRESSION`, `TIME_ZONE_ID`) VALUES ('cc-quartz', 'TaskJobOfDay', 'cc.quartz', '0 5 0 * * ? *', 'Asia/Seoul');
INSERT INTO `QRTZ_CRON_TRIGGERS` (`SCHED_NAME`, `TRIGGER_NAME`, `TRIGGER_GROUP`, `CRON_EXPRESSION`, `TIME_ZONE_ID`) VALUES ('cc-quartz', 'TaskJobOfHour', 'cc.quartz', '0 0 0/1 * * ?', 'Asia/Seoul');
INSERT INTO `QRTZ_CRON_TRIGGERS` (`SCHED_NAME`, `TRIGGER_NAME`, `TRIGGER_GROUP`, `CRON_EXPRESSION`, `TIME_ZONE_ID`) VALUES ('cc-quartz', 'TaskJobOfMonth', 'cc.quartz', '0 0 0 1 * ?', 'Asia/Seoul');
INSERT INTO `QRTZ_CRON_TRIGGERS` (`SCHED_NAME`, `TRIGGER_NAME`, `TRIGGER_GROUP`, `CRON_EXPRESSION`, `TIME_ZONE_ID`) VALUES ('cc-quartz', 'TaskJobOfSecond', 'cc.quartz', '0/2 * * * * ?', 'Asia/Seoul');
COMMIT;
